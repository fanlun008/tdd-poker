...
public class TestTwoPairComparator {
    @Test
    void name() {
        ...
        Card card44 = new Card(CardNumber.CARD_THREE, CardSuit.CLUBS);
        Card card444  =new Card(CardNumber.CARD_ACE, CardSuit.SPADES);

        CardGroup cardGroup1 = new CardGroup();
        cardGroup1.addCard(card1).addCard(card2).addCard(card3).addCard(card44).addCard(card444);
        Pokerutils.computeLevel(cardGroup1);

        Card card4 = new Card(CardNumber.CARD_SEVEN, CardSuit.HEARTS);
        Card card5 = new Card(CardNumber.CARD_NINE, CardSuit.HEARTS);
        Card card6 = new Card(CardNumber.CARD_NINE, CardSuit.SPADES);
        Card card7 = new Card(CardNumber.CARD_SEVEN, CardSuit.SPADES);
        Card card8 = new Card(CardNumber.CARD_TWO, CardSuit.DIAMONDS);

        CardGroup cardGroup2 = new CardGroup();
        cardGroup2.addCard(card4).addCard(card5).addCard(card6).addCard(card7).addCard(card8);
